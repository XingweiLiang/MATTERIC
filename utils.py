...
def init_args(args):
    args.score_save_path = os.path.join(args.save_path + f'_{args.fusion_type.lower()}', args.dataset, 'score.txt')
    args.model_save_path = os.path.join(args.save_path + f'_{args.fusion_type.lower()}', args.dataset)
